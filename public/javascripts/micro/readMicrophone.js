...
function DrawGraph() {
	...
	if(flag1){
		...
		if(freqDetail1.innerHTML != five1[4]){
			...
			five1Time = pushValue((new Date().getTime()), five1Time);
			// five1Time = pushValue(randomTime(), five1Time);
	...
	if(flag2){
		...
		if(freqDetail2.innerHTML != five2[4]){
			flag2 = 0;
			// five3Element.innerHTML = five3Element.innerHTML+"DEF";
			five2Time = pushValue((new Date().getTime()), five2Time);
			// five2Time = pushValue(randomTime(), five2Time);
	...
	if(flag3){
		...
		if(freqDetail3.innerHTML != five3[4]){
			flag3 = 0;
			// five3Element.innerHTML = five3Element.innerHTML+"DEF";
			five3Time = pushValue((new Date().getTime()), five3Time);
